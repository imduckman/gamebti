...
var result = {
  ...
  "INFP": {
    "game": "스타듀벨리",
    "explain1": '<i id=quote>“논리는 A에서 B로 갈 수 있게 한다. 상상력은 어디든지 갈 수 있게 한다.”</i> - Albert Einstein<br><br> <span class="highlight">낭만적인 이상주의자</span>는 긍정적이고 상냥한 성격의 이타주이자입니다. 겉으로는 조용하지만 타인을 생각하는 <span class="highlight">배려심</span>이 깊어 남을 지배하거나 경쟁하는 것을 좋아하지 않는 반면, 자유로운 것을 좋아해 상상력이 뛰어나고 <span class="highlight">자신이 하는 일에 의미</span>를 찾고자 하는 경향이 강합니다.<br><br> 이런 성향의 낭만적인 이상주의자에게는 귀농 힐링 게임인 <span class="highlight">스타듀밸리</span>를 추천드립니다. 삭막한 도시를 떠나 자신만의 농장을 가꾸며 마을 주민들과 따뜻한 교감을 나눌 수 있는 게임입니다. 타인과의 경쟁보다는 <span class="highlight">자신만의 속도와 방식</span>으로 평화로운 일상을 만들어가며 정서적 안정을 찾을 수 있습니다. 마을 곳곳에 숨겨진 이야기들을 발견하고 소중한 인연들과 <span class="highlight">깊은 유대감</span>을 쌓으며 당신의 감성을 충전해보세요!<br><br> 이와 비슷한 게임으로 <span class="highlight">썸썸 편의점</span>, <span class="highlight">워킹데드</span>, <span class="highlight">디트로이트:비컴 휴먼</span>, <span class="highlight">더 라스트 오브 어스</span>를 추천드립니다. RPG 요소와 좀 더 많은 상호작용을 원하신다면 <span class="highlight">돈 스타브</span>를 추천드립니다.',
